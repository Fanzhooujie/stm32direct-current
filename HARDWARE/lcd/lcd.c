...
坐标，转速，数据显示
********************************************************************************************/
void LCD_Coor(float DATE,float changeDat)
{	
  ...
  LCD_ShowString(225,160,200,16,16,lcd_DATA);
	...
	LCD_ShowString(5,180,200,12,12,"40");
	LCD_ShowString(5,160,200,12,12,"60");
	LCD_ShowString(5,140,200,12,12,"80");
	LCD_ShowString(1,120,200,12,12,"100");
	LCD_ShowString(1,100,200,12,12,"120");
	LCD_ShowString(1,80,200,12,12,"140");
	LCD_ShowString(1,60,200,12,12,"160");
	LCD_ShowString(1,40,200,12,12,"180");
	LCD_ShowString(1,20,200,12,12,"200");
	LCD_dateInit();
		
	Lastx=x;
	Lasty=y;
	if(DATE==0.0) y=220;
	else if(DATE==200.0)  y=20;
	else if(DATE>0.0&&DATE<200.0)  y=220-DATE;   //画速度曲线
	x++;
	LCD_Fill(x,20,x,219,WHITE);
...
void LCD_Angle(float gle,float changeDat)
{
  ...
  float angle;
	...
	LCD_DrawLine(20,20,20,220);
	LCD_DrawLine(20,220,220,220);
  LCD_ShowString(25,20,200,16,16,"Angle");
	LCD_ShowString(15,220,200,12,12,"0");   //纵坐标
	LCD_ShowString(1,200,200,12,12,"40");
	LCD_ShowString(1,180,200,12,12,"80");
	LCD_ShowString(1,160,200,12,12,"120");
	LCD_ShowString(1,140,200,12,12,"160");
	LCD_ShowString(1,120,200,12,12,"200");
	LCD_ShowString(1,100,200,12,12,"240");
	LCD_ShowString(1,80,200,12,12,"280");
